...
// когда нет Вы, все согласовали - показывать последних 5
export const pathsHistory2 = [
  {
    stepId: '-1',
    activityId: 'activityId',
    activityText: 'Согласование заявки',
...
// когда нет Вы, до - 1 согласовали, после не согласовали
...
// когда нет Вы, до - 3 согласовали, после 4 не согласовал
