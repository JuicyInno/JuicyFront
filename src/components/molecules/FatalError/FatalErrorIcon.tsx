...
export default ({ variant = 'default' }: IProps) => {
  ...
  if (variant === 'server') {
    ...
    return <svg width='200' height='200' viewBox='0 0 200 200' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <mask id='mask0_692:199' maskUnits='userSpaceOnUse' x='32' y='34' width='109' height='109'>
        <circle cx='86.3419' cy='88.3419' r='54.2569' fill='#EEF1F7' />
      </mask>
      <g mask='url(#mask0_692:199)'>
        <circle cx='86.3419' cy='88.3419' r='66.4267' fill='white' />
        ...
        <g filter='url(#filter0_f_692:199)'>
          <path fill-rule='evenodd' clip-rule='evenodd' d='M88.2574 132.015C116.29 132.015 139.015 109.29 139.015 81.2574C139.015 53.2249 116.29 30.5 88.2574 30.5C60.2249 30.5 37.5 53.2249 37.5 81.2574C37.5 109.29 60.2249 132.015 88.2574 132.015Z' fill='url(#paint0_linear_692:199)' />
        </g>
        <path d='M100.499 54.8437L87.4188 61.6995L87.2998 61.7619L87.2861 61.8955L86.1462 73.0162L75.3303 78.3015L65.4841 73.7545L59.1887 55.4296L59.1595 55.3445L59.0827 55.2976L48.2101 48.6493L47.9968 48.5189L47.8664 48.7322L46.3014 51.2916L46.1709 51.5049L46.3842 51.6353L56.2587 57.6733L62.625 76.2043L62.6597 76.3053L62.7566 76.3501L85.0894 86.6636L88.8659 105.557L74.003 145.024L73.9149 145.258L74.1489 145.347L76.9564 146.404L77.1903 146.492L77.2784 146.258L92.4692 105.92L92.4944 105.853L92.4804 105.783L88.3989 85.3638L90.5899 63.9891L126.199 45.3257L126.42 45.2096L126.304 44.9882L124.912 42.3311L124.796 42.1096L124.574 42.2257L103.879 53.0723L102.259 30.9149L102.241 30.6655L101.991 30.6838L98.9994 30.9026L98.7501 30.9208L98.7683 31.1701L100.499 54.8437ZM85.1401 82.8318L79.4288 80.1943L85.7258 77.1172L85.1401 82.8318Z' fill='url(#paint1_radial_692:199)' stroke='url(#paint2_linear_692:199)' stroke-width='0.5' />
        <path fill-rule='evenodd' clip-rule='evenodd' d='M100.753 54.8819L99.0173 31.1519L102.009 30.9331L103.657 53.4706L124.69 42.4471L126.083 45.1043L90.3546 63.83L88.146 85.3758L92.2349 105.832L77.0442 146.17L74.2367 145.113L89.1248 105.578L85.3094 86.4899L62.8612 76.1231L56.4656 57.5069L46.5144 51.422L48.0794 48.8626L58.952 55.5109L65.2821 73.9367L75.333 78.5783L86.3805 73.1799L87.5345 61.921L100.999 54.8639L100.753 54.8819ZM86.0201 76.695L78.8461 80.2006L85.3528 83.2055L86.0201 76.695Z' fill='url(#paint3_linear_692:199)' />
        <g filter='url(#filter1_f_692:199)'>
          <path fill-rule='evenodd' clip-rule='evenodd' d='M86.2574 140.015C114.29 140.015 137.015 117.29 137.015 89.2574C137.015 61.2249 114.29 38.5 86.2574 38.5C58.2249 38.5 35.5 61.2249 35.5 89.2574C35.5 117.29 58.2249 140.015 86.2574 140.015Z' stroke='url(#paint4_linear_692:199)' stroke-width='5' />
        </g>
      </g>
      <mask id='mask1_692:199' maskUnits='userSpaceOnUse' x='119' y='118' width='51' height='50'>
      ...
      <path d='M86.2574 139.265C114.428 139.265 137.265 116.428 137.265 88.2574C137.265 60.0868 114.428 37.25 86.2574 37.25C58.0868 37.25 35.25 60.0868 35.25 88.2574C35.25 116.428 58.0868 139.265 86.2574 139.265Z' stroke='url(#paint7_linear_692:199)' stroke-width='0.5' />
      <defs>
        <filter id='filter0_f_692:199' x='33.5' y='26.5' width='109.515' height='109.515' filterUnits='userSpaceOnUse' color-interpolation-filters='sRGB'>
          <feFlood flood-opacity='0' result='BackgroundImageFix' />
          <feBlend mode='normal' in='SourceGraphic' in2='BackgroundImageFix' result='shape' />
          <feGaussianBlur stdDeviation='2' result='effect1_foregroundBlur_692:199' />
        </filter>
        <filter id='filter1_f_692:199' x='21' y='24' width='130.515' height='130.515' filterUnits='userSpaceOnUse' color-interpolation-filters='sRGB'>
          <feFlood flood-opacity='0' result='BackgroundImageFix' />
          <feBlend mode='normal' in='SourceGraphic' in2='BackgroundImageFix' result='shape' />
          <feGaussianBlur stdDeviation='6' result='effect1_foregroundBlur_692:199' />
        </filter>
        <linearGradient id='paint0_linear_692:199' x1='96.5' y1='31' x2='72' y2='127.5' gradientUnits='userSpaceOnUse'>
          <stop stop-color='#EFF2F8' />
          <stop offset='0.967839' stop-color='#E3E9F1' />
        </linearGradient>
        <radialGradient id='paint1_radial_692:199' cx='0' cy='0' r='1' gradientUnits='userSpaceOnUse' gradientTransform='translate(86.3419 88.3419) rotate(92.9817) scale(64.2451 43.7776)'>
          <stop stop-color='#C1CCDC' />
          <stop offset='0.57585' stop-color='#C1CCDC' stop-opacity='0' />
        </radialGradient>
        <linearGradient id='paint2_linear_692:199' x1='86' y1='31' x2='95.5' y2='159.5' gradientUnits='userSpaceOnUse'>
        ...
        <linearGradient id='paint3_linear_692:199' x1='97.5' y1='33' x2='77' y2='143' gradientUnits='userSpaceOnUse'>
        ...
        <linearGradient id='paint4_linear_692:199' x1='107.5' y1='43.5' x2='82' y2='142.5' gradientUnits='userSpaceOnUse'>
          <stop offset='0.0362397' stop-color='#8197B6' />
          <stop offset='1' stop-color='#8197B6' stop-opacity='0' />
        </linearGradient>
        <linearGradient id='paint5_linear_692:199' x1='86.2574' y1='28' x2='86.2574' y2='148.515' gradientUnits='userSpaceOnUse'>
          <stop stop-color='#9EB1CD' />
          <stop offset='0.72594' stop-color='#8196B5' />
        </linearGradient>
        <linearGradient id='paint6_linear_692:199' x1='86.2574' y1='28' x2='86.2574' y2='148.515' gradientUnits='userSpaceOnUse'>
          <stop stop-color='#9EB1CD' />
          <stop offset='0.72594' stop-color='#8196B5' />
        </linearGradient>
        <linearGradient id='paint7_linear_692:199' x1='86.2574' y1='37.5' x2='86' y2='143' gradientUnits='userSpaceOnUse'>
