...
export default ({ variant = 'default' }: IProps) => {
  ...
  return <svg width='200' height='200' viewBox='0 0 200 200' fill='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    <path fill-rule='evenodd' clip-rule='evenodd' d='M158.331 173.67C156.368 175.633 153.182 175.621 151.233 173.644L116.744 138.642L137.41 117.975L170.977 151.051C173.745 153.778 173.762 158.239 171.014 160.986L158.331 173.67Z' fill='#8197B6' />
