  ...
  return (
    <Story name='Badge (Значок)' description='Создает значок в правом верхнем углу элемента.'>
      ...
      <StoryItem subtitle='Простой значок info S'>
        <Badge size='S' variant={args.variant} >
      ...
      <StoryItem subtitle='Простой значок M '>
        <Badge badgeContent='5' variant={'error'} >
        </Badge>
      </StoryItem>
      <StoryItem subtitle='Простой значок  S'>

        <Badge placeNear={true} size='M' badgeContent='5' variant={'error'} >
          <p>  Заголовок</p>
        </Badge>
      </StoryItem>
      ...
      <StoryItem subtitle='Простой значок'>
        ...
        <Badge position='topLeft' badgeContent='5' size='M' variant='success'>
